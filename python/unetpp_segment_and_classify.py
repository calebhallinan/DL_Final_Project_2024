# -*- coding: utf-8 -*-
"""unetpp_segment_and_classify.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/120q9wyZ_lhVcUfqKVLfWj285ZjrxARKd
...
class SmallerUNetPlusPlusWithClassifier(nn.Module):
    def __init__(self, n_class, n_class_global):
        super(SmallerUNetPlusPlusWithClassifier, self).__init__()
...
model = SmallerUNetPlusPlusWithClassifier(n_class=4, n_class_global = 5).to(device)
print(model)
...
images_tensor = torch.from_numpy(images_array_train).unsqueeze(1).float()
ground_truths_tensor = torch.from_numpy(ground_truths_array_train).long()
