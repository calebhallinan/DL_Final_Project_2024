...
class DiceLoss(nn.Module):
    ...
    def _one_hot_encoder(self, input_tensor):
        ...
        input_tensor = input_tensor.unsqueeze(1)  # Add a singleton dimension at index 1
        one_hot = torch.zeros(input_tensor.size(0), self.n_classes, *input_tensor.shape[2:], device=input_tensor.device)
        one_hot.scatter_(1, input_tensor, 1)  # Fill the one-hot tensor
        return one_hot
